...
class MainWindow(QMainWindow):
    def __init__(self, store, anthropic_client):
        ...
        self.settings = QSettings('Computer_Agent', 'Preferences')
        ...
        self.setWindowTitle("Computer_Agent 🤖")
        self.setGeometry(100, 100, 400, 600)
        self.setMinimumSize(600, 700)  # Increased minimum size for better usability
    ...
    def setup_ui(self):
        ...
        title_label = QLabel("Computer_Agent 🤖")
    ...
    def setup_tray(self):
        ...
        title_action = tray_menu.addAction("Computer_Agent 🤖")
